...
// 注册 Service
builder.Services.AddTransient<Servicemy>();

#endregion


#region 注册服务配置新版
builder.Services.AddScoped(typeof(Ireposity<>),typeof(Repository<>));//指定了泛型类型
builder.Services.AddScoped<IServicemy, Servicemy>();
